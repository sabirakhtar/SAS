...
DATA uspresidents;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\President.dat';
   INPUT President $ Party $ Number;
RUN;
...
DATA toads;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\ToadJump.dat';
...
DATA sales;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\OnionRing.dat';
...
DATA contest;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\Pumpkin.dat';
...
DATA nationalparks;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\NatPark.dat';
...
DATA highlow;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\Temperature.dat';
   INPUT City $ State $ 
...
DATA freeways;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\Traffic.dat';
   INPUT Type $ @;
...
DATA icecream;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\IceCreamSales2.dat' FIRSTOBS = 3 OBS=5;
   INPUT Flavor $ 1-9 Location BoxesSold;
RUN;
...
DATA class102;
   INFILE 'C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\AllScores.dat' MISSOVER;
...
PROC IMPORT DATAFILE ='C:\Users\sakhtar\Downloads\Business Analytics Tools - Commercial\LSB5_Data\MyRawData\Bands2.csv' OUT = music REPLACE;
RUN;
PROC PRINT DATA = music;    
   TITLE 'Customers at Each Gig'; 
RUN;
